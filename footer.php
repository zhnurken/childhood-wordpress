<div class="question">
        ...
        <div class="reply">
            <div class="reply__body">
                ...
                <?php echo do_shortcode('[contact-form-7 id="137" title="Форма вопросов"]');?>
            </div>
        </div>
        <footer>
            <div class="container">
        ...
        <?php
            wp_footer();
        ?>
        <script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyA0wh-iveKMSWHxlV-yyRrPIVHH7tzEHzQ"></script> 
